...
ModificationParsingError.prototype.getGenericMessage = function(prefixWithName = true) { return `${prefixWithName ? `${this.name}: ` : ""}Some properties cannot be parsed!` }
...
ModificationPackageNotAvailableError.prototype.getGenericMessage = function(prefixWithName = true) { return `${prefixWithName ? `${this.name}: ` : ""}Some Packages not available!` }
